...
def main():
    ...
    # --- Container for Action Bar and Chat Input ---
    # This keeps the actions and the input together at the bottom.
    ...
    with bottom_container:
        ...
        # Simplified button creation loop
        for i, (icon, (caption, action_key)) in enumerate(button_actions.items()):
            with cols[i]:
                if st.button(icon, help=f"{caption} action", use_container_width=True):
